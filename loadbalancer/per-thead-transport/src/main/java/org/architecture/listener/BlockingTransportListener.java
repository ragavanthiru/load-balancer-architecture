...
import org.architecture.thread.ProxyHandler;
...
public class BlockingTransportListener extends Thread {
    ...
    public BlockingTransportListener(final int port, final HttpHost target) throws IOException {
        this.target = target;
